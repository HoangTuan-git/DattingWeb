                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="view/dangnhap.php">Đăng nhập</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row align-items-center min-vh-100">
                    <div class="col-lg-6">
                        ...
                        <div class="fade-in-up delay-2">
                            ...
                            <a href="home.php" class="btn-hero btn-outline-hero">
            ...
            <div class="cta-card">
                <div class="cta-content">
                    ...
                    <div>
                        ...
                        <a href="home.php" class="btn btn-outline-light btn-lg rounded-pill px-4">
                            Dùng thử miễn phí
                        </a>
                    </div>
                </div>
